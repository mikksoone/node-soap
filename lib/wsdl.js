...
PortElement.prototype.addChild = function(child) {
   if (child.name === 'address' &&
       typeof(child.$location) !== 'undefined') {
...
MessageElement.prototype.postProcess = function(definitions) {
    ...
    if (part.$element) {
        ...
        for (var i=0, part; part = this.children[i]; i++) {
            ...
            if (typeof schemaDefinition !== 'undefined' && definitions.schemas[ns]) {
...
WSDL.prototype.xmlToObject = function(xml) {
    ...
    p.on('text', function(text) {
        ...
        var name = typeof top.schema === 'string' ? 
            splitNSName(top.schema).name : "";
        var value;
